...
spans = [
    {"name": "A", "text": "During testing we found an anomaly.", "start": 45.0, "end": 50.0, "idxs": [0]},
    {"name": "B", "text": "The Quantum Core is sentient.", "start": 45.0, "end": 50.0, "idxs": [1]},
    {"name": "C", "text": "This changes everything.", "start": 45.0, "end": 50.0, "idxs": [2]},
]
